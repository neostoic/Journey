...
module.exports = {
    parseUploadedData: function(req, res) {
        ...
        async.eachSeries(data_dump_profiles, function(person, callbackNext) {
            i++
            console.log("GOING OVER PERSON #:", i)
            ...
            var createProfile = function(createProfileCallback) {
                new Profile({
                    ...
                    .then(function(profile) {
                        ...
                        console.log("OBJ.ProfileID just set for person #", i, " Obj:", obj)
            ...
            var createEduMilestones = function(outerCallback) {
                console.log("In createEduMilesotnes. entire obj object at start for person #", i, " looks like:", obj)
                console.log("CREATE EDUCAITON MILESTONES IS RUNNING FOR PERSON #", i)
                ...
                async.eachSeries(person.educationList, function(eduMilestone, nextMilestone) {
                    ...
                    console.log("In createEduMilesotnes. milestone object at start for person #", i, " looks like:", milestone)
                  ...
                  console.log("done with education loop for person # ", i)
